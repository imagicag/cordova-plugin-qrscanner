...
public class CameraSource {
    ...
    public synchronized CameraSource start() throws IOException {
        ...
        camera.startPreview();
        CommonData.getInstance().setCamera(camera);
    ...
    private Camera createCamera() throws IOException {
        ...
        requestedPreviewWidth = (metrics.heightPixels - 350) / 2;
        requestedPreviewHeight = metrics.widthPixels / 2;
        ...
        if (parameters.getSupportedFlashModes() != null
                && parameters
                        ...
                        .contains(CommonData.getInstance().flashMode)) {
            parameters.setFlashMode(CommonData.getInstance().flashMode);
        }
    ...
    public static Size getPictureSize(Camera camera, int desiredWidth, int desiredHeight) {
        SizePair pair = selectSizePair(camera, desiredWidth, desiredHeight);
        return pair.picture;
    }
